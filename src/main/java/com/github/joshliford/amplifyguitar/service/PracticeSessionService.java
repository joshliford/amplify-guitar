...
public class PracticeSessionService {
    ...
    public PracticeSessionService(PracticeSessionRepository practiceSessionRepository, ProgressService progressService) {
        this.practiceSessionRepository = practiceSessionRepository;
        this.progressService = progressService;
    }

    public PracticeSession startPracticeSession(User user, PracticeGoal goal) {
    ...
    public PracticeSession endPracticeSession(Integer sessionId) {
        ...
        // if user chooses a "freeform" practice, return early and do not award XP
        if (sessionGoal == null) {
