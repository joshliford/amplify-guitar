export default function SectionCard({ title, icon, children, className }) {
  return (
    ...
    <div className={`flex flex-col w-full rounded-xl border border-primary/50 hover:border-primary hover:-translate-y-1 bg-(--bg-surface) shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden ${className || ''}`}>
