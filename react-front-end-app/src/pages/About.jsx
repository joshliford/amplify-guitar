...
export default function About() {
  return (
    <main className="bg-[#FFFEF7] dark:bg-black text-lg">
      <section className="space-y-4 py-12 px-12">
        <div className="flex justify-center">
          <h1 className="text-2xl text-center font-bold border-b-2 border-b-[#D4A574] inline-block">
            About Amplify
          </h1>
        </div>
        <p>
          <strong className="text-[#1F5D3D] dark:text-[#EBD5B3] text-xl">
            Amplify
          </strong>{" "}
      ...
      <section className="space-y-4 py-12 px-12 mt-12">
        <div className="flex justify-center">
          <h2 className="text-2xl text-center font-bold border-b-2 border-b-[#D4A574] inline-block">
            Purpose
          </h2>
        </div>
      ...
      <section className="py-12 px-12 mt-12 flex flex-col items-center mb-6">
        <div className="w-full max-w-8xl">
          <div className="flex justify-center mb-6">
            <h3 className="text-2xl font-bold border-b-2 border-b-[#D4A574] inline-block text-center">
              Core Pages
            </h3>
          </div>
          <div className="w-full max-w-8xl shadow-2xl rounded-xl overflow-hidden border-2 border-[#D4A574] bg-white dark:bg-[#1A1F2A]">
            <Table className="text-lg">
              <TableHeader className="bg-[#1F5D3D] dark:bg-[#D4A574] text-xl border-b-3 border-[#D4A574]">
              ...
              <TableBody>
                <TableRow className="text-lg">
                  <TableCell className="text-[#1F5D3D] dark:text-[#EBD5B3] font-semibold text-xl pl-4">
                    The Dashboard
                  </TableCell>
                ...
                <TableRow>
                  <TableCell className="text-[#1F5D3D] dark:text-[#EBD5B3] font-semibold text-lg  pl-4">
                    The Shed
                  </TableCell>
                  <TableCell>
